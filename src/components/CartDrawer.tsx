        ...
        {items.length === 0 ? (
          ...
          <>
            ...
            <div className="border-t border-hairline p-6 space-y-4">
              ...
              {remaining > 0 ? (
                <div>
                  <p className="text-[11px] text-ink-soft mb-2">Add {currency(remaining)} more for free shipping</p>
                  <div className="h-1 bg-surface-dim rounded-full overflow-hidden">
                    <div className="h-full bg-primary transition-all duration-500" style={{ width: `${progress}%` }} />
                  </div>
                </div>
              ) : (
                <p className="text-[11px] text-emerald-700 font-medium">✓ You qualify for free shipping</p>
              )}
